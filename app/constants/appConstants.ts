...
export default {
  ...
  androidFolder: `${RNFetchBlob.fs?.dirs.DCIMDir}/MovieDB/Images`,
  androidProfileFolder: `${RNFetchBlob.fs?.dirs.DCIMDir}/MovieDB/Profile`,
  iosFolder: `${RNFetchBlob.fs?.dirs.DocumentDir}/MovieDB/Images`,
  iosProfileFolder: `${RNFetchBlob.fs?.dirs.DocumentDir}/MovieDB/Profile`,
